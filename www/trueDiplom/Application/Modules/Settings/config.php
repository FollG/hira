...
return [
    ...
    'route' => [
        ...
        'settings/post/setstatus' => [
            'controller' => 'Settings\Controllers\Settings',
            'action' => 'post_setStatus',
            'name' => 'Settings',
            'method' => 'POST',
        ],
        'settings/post/setsurgency' => [
            'controller' => 'Settings\Controllers\Settings',
            'action' => 'post_setSurgency',
            'name' => 'Settings',
            'method' => 'POST',
        ],
        'settings/post/setuser' => [
            'controller' => 'Settings\Controllers\Settings',
            'action' => 'post_setUser',
            'name' => 'Settings',
            'method' => 'POST',
        ],
        'settings/post/setproject' => [
            'controller' => 'Settings\Controllers\Settings',
            'action' => 'post_setProject',
            'name' => 'Settings',
            'method' => 'POST',
        ],
        'settings/post/setrole' => [
            'controller' => 'Settings\Controllers\Settings',
            'action' => 'post_setRole',
            'name' => 'Settings',
            'method' => 'POST',
